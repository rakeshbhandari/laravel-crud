<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Blog Recipes</span>
        </a>
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <!-- below code renders nav dynamically showing active status  -->
                ...
                <x-navbar-link href="{{ route('register') }}" :active="request()->is('request')">
                    Register </x-navbar-link>
                @endguest
                @auth
